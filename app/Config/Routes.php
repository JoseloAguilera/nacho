...
$routes->group('products', ['filter' => 'auth'], function($routes) {
    ...
    $routes->get('create', 'Products::create', ['filter' => 'role:admin']);
    $routes->post('store', 'Products::store', ['filter' => 'role:admin']);
    $routes->get('edit/(:num)', 'Products::edit/$1', ['filter' => 'role:admin']);
    $routes->post('update/(:num)', 'Products::update/$1', ['filter' => 'role:admin']);
    $routes->get('delete/(:num)', 'Products::delete/$1', ['filter' => 'role:admin']);
});

// Categories module (requires admin)
$routes->group('categories', ['filter' => 'role:admin'], function($routes) {
